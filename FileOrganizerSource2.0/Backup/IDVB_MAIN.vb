...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chkRtL As System.Windows.Forms.CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btn_QUIT
        '
        Me.btn_QUIT.Location = New System.Drawing.Point(592, 46)
        ...
        'txt_Extensions
        '
        Me.txt_Extensions.Location = New System.Drawing.Point(229, 94)
        Me.txt_Extensions.Name = "txt_Extensions"
        Me.txt_Extensions.Size = New System.Drawing.Size(161, 20)
        ...
        'txt_Insert
        '
        Me.txt_Insert.Location = New System.Drawing.Point(6, 30)
        Me.txt_Insert.Name = "txt_Insert"
        Me.txt_Insert.Size = New System.Drawing.Size(470, 20)
        ...
        Me.ctl_CharsToOverWriteNum.Location = New System.Drawing.Point(347, 54)
        ...
        'Label3
        '
        Me.Label3.Location = New System.Drawing.Point(190, 53)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(151, 20)
        Me.Label3.TabIndex = 9
        Me.Label3.Text = "Characters to overwrite next:"
        ...
        Me.Label5.Text = "Characters to skip first:"
        ...
        Me.ctl_FirstCharSkipNum.Location = New System.Drawing.Point(144, 53)
        ...
        Me.btn_Insert.Location = New System.Drawing.Point(396, 94)
        Me.btn_Insert.Name = "btn_Insert"
        Me.btn_Insert.Size = New System.Drawing.Size(80, 22)
        Me.btn_Insert.TabIndex = 15
        Me.btn_Insert.Text = "GO!"
        Me.TText.SetToolTip(Me.btn_Insert, "Careful: There's no undo!")
        '
        'TextBox1
        '
        Me.TextBox1.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.TextBox1.Location = New System.Drawing.Point(114, 94)
        ...
        'btn_underscore
        '
        Me.btn_underscore.Location = New System.Drawing.Point(6, 48)
        Me.btn_underscore.Name = "btn_underscore"
        Me.btn_underscore.Size = New System.Drawing.Size(76, 23)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(88, 109)
        ...
        'GroupBox2
        '
        Me.GroupBox2.Controls.Add(Me.chkRtL)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(482, 122)
        ...
        'CBTop
        '
        Me.CBTop.Location = New System.Drawing.Point(592, 106)
        Me.CBTop.Name = "CBTop"
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(592, 76)
        ...
        Me.chkRtL.Location = New System.Drawing.Point(393, 56)
        Me.chkRtL.Name = "chkRtL"
        Me.chkRtL.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        Me.chkRtL.Size = New System.Drawing.Size(80, 17)
        Me.chkRtL.TabIndex = 19
...
#End Region
    ...
    Private Sub btn_Insert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Insert.Click
        ...
        i = Array.BinarySearch(FileExtensions, Filenames(i).Substring(Filenames(i).LastIndexOf(".")))

        'Validate that naming will work for all files.
        For Each NewFilename In Filenames
            If NewFilename.Substring(NewFilename.LastIndexOf("\")).Length _
                - CInt(ctl_FirstCharSkipNum.SelectedValue.ToString()) _
                - CInt(ctl_CharsToOverWriteNum.SelectedValue.ToString()) < _
                NewFilename.Substring(NewFilename.LastIndexOf("\")).Length _
                - (NewFilename.Substring(NewFilename.LastIndexOf(".")).Length + 2) Then
                MsgBox(NewFilename + "'s name would become too short. Process aborted. No files have been changed.", MsgBoxStyle.Critical, "Epik Fail")
                Return
            End If
        Next
        'Rename Loop
        For i = 0 To Filenames.GetUpperBound(0)
            Try 'Try catches errors when the index of substring is greater than the filename length
                ...
                If ((Array.BinarySearch(FileExtensions, Filenames(i).Substring(Filenames(i).LastIndexOf(".")).ToLower) > -1) Or (txt_Extensions.Text = "")) _
                    ...
                    If chkRtL.Checked Then
                        Reverse(NewFilename)
                        txt_Insert.Text = Reverse(txt_Insert.Text)
                    End If
                    'reset skipped character string
                    SkippedChars = ""
                    'if the number of skipped characters is longer than the filename
    ...
    Private Sub btn_underscore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_underscore.Click
        ...
        For i = 0 To Filenames.GetUpperBound(0)
            Try 'Try catches errors when the index of substring is greater than the filename length
                If (((Array.BinarySearch(FileExtensions, Filenames(i).Substring(Filenames(i).LastIndexOf(".")).ToLower) > -1) Or (txt_Extensions.Text = ""))) And (IO.File.GetAttributes(Filenames(i)) <> (IO.FileAttributes.System And IO.FileAttributes.Directory And IO.FileAttributes.Hidden)) Then
                    NewFilename = Filenames(i)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        For i = 0 To Filenames.GetUpperBound(0)
            ...
            Catch ex As ArgumentOutOfRangeException
                MsgBox("A filename was shorter than the number" & Chr(13) & "of characters to overwrite.", MsgBoxStyle.Exclamation, "Error: 004")
            End Try
        Next
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        MsgBox("Filename Fixer v2.0" & Chr(10) & "©Copyright 2009 Benjamin Roth" & Chr(10) _
    ...
    Function Reverse(ByVal str As String) As String
        Dim chr As Char, result As String = ""
        For Each chr In str
            result = chr + result
        Next
        Return result
